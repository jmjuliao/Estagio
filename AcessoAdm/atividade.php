 ...
 */
    ...
    class atividadePage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`atividade`');
            $field = new IntegerField('cod_atividade', null, null, true);
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('desc_atividade');
            $field->SetIsNotNull(true);
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('atividadessearch', $this->dataset,
                array('cod_atividade', 'desc_atividade', 'cod_curso_nome_curso'),
                array($this->RenderText('Cod Atividade'), $this->RenderText('Desc Atividade'), $this->RenderText('Cod Curso')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('atividadeasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            ...
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('desc_atividade', $this->RenderText('Desc Atividade')));
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            // View column for desc_atividade field
            //
            $column = new TextViewColumn('desc_atividade', 'Desc Atividade', $this->dataset);
            $column->SetOrderable(true);
            $column->SetDescription($this->RenderText(''));
            $column->SetFixedWidth(null);
            $grid->AddViewColumn($column);
        ...
        {
            //
            // Edit column for desc_atividade field
            //
            $editor = new TextEdit('desc_atividade_edit');
            $editor->SetSize(30);
            $editor->SetMaxLength(30);
            $editColumn = new CustomEditColumn('Desc Atividade', 'desc_atividade', $editor, $this->dataset);
        ...
        public function GetModalGridDeleteHandler() { return 'atividade_modal_delete'; }
        protected function GetEnableModalGridDelete() { return true; }

        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'atividadeGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
    ...
    try
    {
        $Page = new atividadePage("atividade.php", "atividade", GetCurrentUserGrantForDataSource("atividade"), 'UTF-8');
        $Page->SetShortCaption('Atividade');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Atividade');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("atividade"));
